...
```{r}
pca = plot_pca(cpmd, metadata, join_by_name = 'Sample', plotting_factors_in = 'col_names', plotting_factors_name = Group, x = 'PC1', y = 'PC2', scale = T, center = T, color = 'Hybrid', fill = 'Hybrid', plot_type = '2D')
...
# PCA boxplot
```{r}
pca = plot_pca(cpmd, metadata, join_by_name = 'Sample', plotting_factors_in = 'col_names', plotting_factors_name = Group, x = 'Hybrid', y = 'PC1', scale = T, center = T, color = 'Hybrid', fill = 'PHY_Avg', plot_type = 'boxplot')
...
a = plot_pca(cpmd, metadata, join_by_name = 'Sample', plotting_factors_in = 'col_names', plotting_factors_name = Group, x = 'PC2', y = 'CG_Avg.', scale = T, center = T, plot_type = 'scatter', summarise_for_scatter = T)+
  ggtitle('Trait: Crown Gall Disease')

b = plot_pca(cpmd, metadata, join_by_name = 'Sample', plotting_factors_in = 'col_names', plotting_factors_name = Group, x = 'PC5', y = 'PHY_Avg', scale = T, center = T, plot_type = 'scatter', summarise_for_scatter = T)+
  ggtitle('Trait: Phytophthora Root Rot')

c = plot_pca(cpmd, metadata, join_by_name = 'Sample', plotting_factors_in = 'col_names', plotting_factors_name = Group, x = 'PC1', y = 'TwoY_RLN', scale = T, center = T, plot_type = 'scatter', summarise_for_scatter = T)+
...
pca = plot_pca(PCA_CG, metadata, join_by_name = 'Sample', plotting_factors_in = 'col_names', plotting_factors_name = Group, x = 'PC1', y = 'PC2', scale = T, center = T, color = 'CG_Avg.', fill = 'CG_Avg.', plot_type = '2D')
...
# CG Biological Process by logFC boxplot
```{r}
# BP_CG = impCG %>% 
#   filter(Category == 'biological_process' & logFC^2 >= 0.25) %>% 
#   distinct(GeneID, logFC, Name, Parent_haplotype) %>% 
#   group_by(Name) %>% 
#   mutate(mean = mean(logFC))
# 
# p = ggplot(BP_CG, aes(reorder(Name, logFC), logFC, fill = mean))+
#   geom_boxplot()+
#   theme(axis.text.x = element_text(angle = 30))+
#   scale_fill_gradient2(low = 'blue', high = 'red')
# 
# p
# 
# save_plot('DGEresults/BP_boxplot_CG.png', p, base_height = 20, base_width = 20)
```
