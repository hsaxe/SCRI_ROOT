...
sjPlot::save_plot('DGEresults/PCA_scatter_CG_PH_NEM.png', arr, height = 18, width = 28)
```
...
## Table of results CG
```{r}
impCG = limma::topTable(BlockFit_CG, sort.by = "logFC", p.value = 0.05, adjust.method = "BH", number = Inf) %>%
